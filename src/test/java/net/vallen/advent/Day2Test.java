...
// the program halts?
    ...
    public void day2Example1() {
        String  intCodeProgram = "1,9,10,3,2,3,11,0,99,30,40,50";
        MatcherAssert.assertThat(Day2.processList(Day2.getIntegerListFromLine(intCodeProgram)), is(Lists.newArrayList(3500, 9, 10, 70, 2, 3, 11, 0, 99, 30, 40, 50)));
    }

    @Test
    public void day2Example2() {
        String  intCodeProgram = "1,0,0,0,99";
        MatcherAssert.assertThat(Day2.processList(Day2.getIntegerListFromLine(intCodeProgram)), is(Lists.newArrayList(2,0,0,0,99)));
    }

    @Test
    public void day2Example3() {
        String  intCodeProgram = "2,3,0,3,99";
        MatcherAssert.assertThat(Day2.processList(Day2.getIntegerListFromLine(intCodeProgram)), is(Lists.newArrayList(2,3,0,6,99)));
    }

    @Test
    public void day2Example4() {
        String  intCodeProgram = "2,4,4,5,99,0";
        MatcherAssert.assertThat(Day2.processList(Day2.getIntegerListFromLine(intCodeProgram)), is(Lists.newArrayList(2,4,4,5,99,9801)));
    }

    @Test
    public void day2Example5() {
        String  intCodeProgram = "1,1,1,4,99,5,6,0,99";
        MatcherAssert.assertThat(Day2.processList(Day2.getIntegerListFromLine(intCodeProgram)), is(Lists.newArrayList(30,1,1,4,2,5,6,0,99)));
    }
}
